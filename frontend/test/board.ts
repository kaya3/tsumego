...
.....`;
    ...
    testLegalUnoccupied() {
        ...
        Assert.throwsLike(
            () => board.play(0, 0),
            e => e instanceof IllegalMove && e.reason === 'occupied',
            'Playing at an occupied position should throw',
        );
    }
...
.....`);
        ...
        Assert.throwsLike(
            () => board.play(2, 2),
            e => e instanceof IllegalMove && e.reason === 'ko recapture',
            'Recapturing a ko throws an exception',
        );
...
.w...`);
        ...
        Assert.throwsLike(
            () => board.play(2, 0),
            e => e instanceof IllegalMove && e.reason === 'self-capture',
            'Self-capture throws an exception',
        );
    }
});